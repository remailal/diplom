...
class SiteController extends Controller
{
    ...
    public function actionGallery()
    {
        ...
        $photos = \common\models\Photos::find()->all();
    ...
    public function actionContact()
    {
       ...
       $modelImg = new UploadForm();
        ...
        if ($model->load(Yii::$app->request->post())) {
                  $modelImg->imageFiles = \yii\web\UploadedFile::getInstances($modelImg, 'imageFiles');
                
                $post = Yii::$app->request->post();
                //var_dump($post['ContactForm']['phone']);die;
            $model->fillPoles($post);
            if ($model->save()) {
                if ($modelImg->uploadT($model->id)) {

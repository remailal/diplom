...
jqOld(document).ready(function() {
 ...
 jqOld('.counter').counterUp({
    ...
    jqOld('.img-container').magnificPopup({
        delegate: 'a',
        type: 'image',
    ...
    /* ==============================================
     OWL CAROUSEL
     =============================================== */
   jqOld('.testimonial_carousel').slick({
        dots: true,
        autoplay: true,
        autoplaySpeed: 2000,
        arrows: false
    ...
    var waypoints = jqOld('.progress_container').waypoint(function() {

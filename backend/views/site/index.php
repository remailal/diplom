    ...
    <div class="container marketing" style="margin-top: 3%;">
     ...
     <?php /*foreach ($news as $new): */ for ($i = 0; $i < count($news); $i++) {?>
      ...
      <div class="row featurette">
        <div class="col-md-7">
            <h2 class="featurette-heading"><?=Html::a($news[$i]->title, ['editnew','id'=>$news[$i]->id]);?></h2>
          <p class="lead">
        <?= $news[$i]->short?>
        </div>
        <div class="col-md-5">
          <img class="featurette-image img-responsive blogimgbottom" src="/frontend/web/uploads/<?= $news[$i]->pic?>" alt="">
        </div>
      </div>
      <hr class="featurette-divider">
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive blogimgbottom" src="/frontend/web/uploads/<?= $news[$i+1]->pic?>" alt="">
        </div>
        <div class="col-md-7">
          <h2 class="featurette-heading"><?=Html::a($news[$i+1]->title, ['editnew','id'=>$news[$i+1]->id]);?></h2>
